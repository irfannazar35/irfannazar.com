...
const PROJECTS_DATA = [
  {
    ...
    image: 'assets/images/punjab-irrigation-logo.jpg',
  ...
  },
  {
    ...
    pid: 'FLD · CH',
    category: 'hydroinformatics',
    title: 'Chenab River Flood Monitoring, Mapping & Early Warning',
    shortDesc: 'Flood tracking and inundation mapping for Chenab River reaches, combining barrage discharge trends, Sentinel-1 SAR observations, GIS analysis, and public-facing bulletins.',
    fullDesc: 'Developed flood monitoring and communication products for Chenab River flood response, including hydrographic trend tracking, public-facing warning bulletins, and geospatial inundation mapping using Sentinel-1 SAR imagery, QGIS, and Google Earth Engine. Recent mapping focused on the Qadirabad-to-Talibwala reach and floodwater persistence across affected villages and agricultural land.',
    tags: ['Flood Early Warning', 'Sentinel-1 SAR', 'Google Earth Engine', 'QGIS'],
    metrics: 'Chenab River Flood Intelligence',
    image: 'assets/images/punjab-irrigation-logo.jpg',
    client: 'Small Dams Division / Flood Cell',
    impact: 'Turned hydrological and satellite observations into clearer situational awareness for flood response teams and downstream communities.'
  },
  {
    id: 'nbs-aa',
    pid: 'NBS · AA',
    category: 'hydroinformatics',
    title: 'Nature-Based Solutions Climate Adaptation Study',
    shortDesc: 'IHE Delft MSc research evaluating NBS effectiveness for climate change adaptation in the Aa of Weerijs catchment, Netherlands.',
    fullDesc: 'Investigated the effectiveness of Nature-Based Solutions for climate adaptation using a coupled MIKE SHE-MIKE 11 model of the Aa of Weerijs catchment. The study examined rainfall-runoff response, hydraulic behavior, and adaptation outcomes, and was presented through EGU General Assembly 2023 and NCR Days 2023 conference abstracts.',
    tags: ['MIKE SHE', 'MIKE 11', 'Nature-Based Solutions', 'Climate Adaptation'],
    metrics: 'IHE Delft MSc Research',
    image: 'assets/images/ihe-delft-logo.png',
    client: 'IHE Delft Institute for Water Education',
    impact: 'Connected catchment-scale modeling with practical climate adaptation planning for water and land-use management.'
  },
  {
    id: 'gis-rf',
    pid: 'GIS · RF',
